...
import 'package:flutter_app_backend/singup_login/register.dart';
...
/*      'email' : emailController.text,
    ...
    var res = await CallApi().login('login', param);
                ...
                Row(
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child:TextWidget(text:"Register", fontSize:16, isUnderLine:true),
                    ),
                    GestureDetector(
                      onTap: (){
